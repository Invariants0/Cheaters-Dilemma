  ...
  return (
    <GamePanel title="CONFIGURATION">
      <div className="space-y-3">
        <div>
          <label className="block text-xs text-[#94a3b8] mb-1">AGENTS</label>
          <input
            type="number"
            ...
            className="w-full bg-[#1a1f2e] border border-[#94a3b8] text-[#eab308] px-2 py-1 text-xs font-mono"
            min="2"
            max="20"
          />
        </div>
        <div>
          <label className="block text-xs text-[#94a3b8] mb-1">SEED</label>
          <input
            type="number"
            value={config.seed}
            onChange={(e) =>
